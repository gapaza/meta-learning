...
class GA_Task(AbstractTask):
    ...
    def __init__(self, run_num=0, barrier=None, problem=None, limit=50, actor_load_path=None, critic_load_path=None, debug=False):
        ...
        self.offspring_size = 5  # 32 FU_NSGA2, 30 U_NSGA2
    ...
    @tf.function(input_signature=[
        tf.TensorSpec(shape=(5, None), dtype=tf.float32),
        tf.TensorSpec(shape=(5, 610), dtype=tf.float32),
        tf.TensorSpec(shape=(5, 610), dtype=tf.float32),
    ...
    @tf.function(input_signature=[
        tf.TensorSpec(shape=(5, 60), dtype=tf.float32),
        tf.TensorSpec(shape=(5, 60), dtype=tf.int32),
        tf.TensorSpec(shape=(5, 60), dtype=tf.float32),
        tf.TensorSpec(shape=(5, 60), dtype=tf.float32),
        tf.TensorSpec(shape=(5, 610), dtype=tf.float32),
        tf.TensorSpec(shape=(5, 610), dtype=tf.float32)
    ...
    @tf.function(input_signature=[
        tf.TensorSpec(shape=(5, 61), dtype=tf.float32),
        tf.TensorSpec(shape=(5, 61), dtype=tf.float32),
        tf.TensorSpec(shape=(5, 610), dtype=tf.float32),
        tf.TensorSpec(shape=(5, 610), dtype=tf.float32)
    ])
