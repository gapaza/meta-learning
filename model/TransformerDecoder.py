...
from model.CachedMultiHeadAttention import CachedMultiHeadAttention
...
class TransformerDecoder(keras.layers.Layer):
    ...
    def call(
        ...
        x, self_attention_cache, self_attn_scores = self._self_attention_layer(
            query=x,
            value=x,
        ...
        if has_cross_attention:
            ...
            x, cross_attention_cache, cross_attn_scores = self._cross_attention_layer(
                query=x,
        ...
        if self_attention_cache is not None:
            if has_cross_attention:
                return (x, self_attention_cache, cross_attention_cache), cross_attn_scores
            else:
                return (x, self_attention_cache), cross_attn_scores
        else:
            return x, cross_attn_scores
